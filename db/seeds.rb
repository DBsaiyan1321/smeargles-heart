...
third_imagination = Imagination.create!(title: "Zapdos Background", description: "An awesom wallpaper for Zapdos fans!", artist_id: 2)
file3 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/zap-dos.jpg")
third_imagination.image.attach(io: file3, filename: 'zap-dos.jpeg')

fourth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
file4 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/drawing.jpg")
fourth_imagination.image.attach(io: file4, filename: 'drawing.jpeg')

fifth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
file6 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/beautiful-water.jpeg")
sixth_imagination.image.attach(io: file6, filename: 'beautiful-water.jpeg')

seventh_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
eight_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
ninth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
tenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
eleventh_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twelth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
file12 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/butterfly-eye.jpeg")
twelth_imagination.image.attach(io: file12, filename: 'butterfly-eye.jpeg')

thirteenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
forteenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fifteenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
sixteenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
file16 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/conquer.jpeg")
sixteenth_imagination.image.attach(io: file16, filename: 'conquer.jpeg')

seventeenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
eighteenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
ninteenth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
file20 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/future.jpeg")
twenty_imagination.image.attach(io: file20, filename: 'future.jpeg')

twentyone_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twentytwo_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twentythree_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
file23 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/highway.jpeg")
twentythree_imagination.image.attach(io: file23, filename: 'highway.jpeg')

twentyfourth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twentyfifth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twentysixth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twentyseventh_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twentyeight_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
twentynine_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
thirty_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
thirtyfirst_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
thirtyfourth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
thirtysixth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
thirtyseventh_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
thirtyeigth_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
thirtynine_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
forty_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fourthone_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fourthtwo_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fourththree_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fourthfour_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fourthfive_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
file45 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/reflection.jpeg")
fourthfive_imagination.image.attach(io: file45, filename: 'reflection.jpeg')

fourthsix_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fourthseven_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
file47 = open("https://smearglesheart-seeds.s3-us-west-1.amazonaws.com/Smeargles-Heart/sf.jpeg")
fourthseven_imagination.image.attach(io: file47, filename: 'sf.jpeg')

fourtheight_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fifty_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fiftyone_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
...
fiftytwo_imagination = Imagination.create!(title: "Pokeball Sketch", description: "I messed up on a pokeball sketch, which led to this. I hope you like it :D", artist_id: 6)
